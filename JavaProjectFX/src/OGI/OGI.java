...
/**
*   just change the file pathname in line 44 .....
* */
public class OGI extends Application {

    File file = new File("C:\\Users\\Enes\\IdeaProjects\\JavaProjectFX");
    Stage window ;
    ...
    void playOluştur(){
        ...
        try {
            Scanner level1txt = new Scanner(
                    new File("C:\\Users\\Enes\\IdeaProjects\\JavaProjectFX\\level"+String.valueOf(bölüm)+".txt")
            );
    ...
    void level1Scene(){
        ...
        try {
            Scanner level1txt = new Scanner(
                    new File(file.toString()+"\\level"+String.valueOf(bölüm)+".txt")
            );
            while (level1txt.hasNext()) {
                String next = level1txt.next();
                String[] intypo = next.split(",");
